...
const config: Config = {
  content: [
    ...
    "./node_modules/@nextui-org/theme/dist/components/(button|dropdown|modal|popover|progress|select|slider|spinner|tabs|ripple|menu|divider|listbox|scroll-shadow).js"
  ],
  theme: {
    extend: {
      backgroundImage: {
