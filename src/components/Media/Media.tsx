  ...
  return (
    <div className="my-4 py-5">
      <div className="border-t-2 border-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] py-4 divide-y md:divide-y-0 md:divide-x divide-dashed divide-[#1f1d1a4d]">
          <div className="pr-0 md:pr-3">
            <PoliticsCardWithImage />
          </div>
          <div className="pl-0 md:pl-3 grid grid-rows-[1fr_10px_1fr] divide-y divide-dashed divide-[#1f1d1a4d]">
