...
interface ShareLinkProps extends React.HTMLAttributes<HTMLDivElement> {
  title: string;
  url: string;
  id: string;
  appendClassName?: string;
...
export function ShareLinks({
  ...
  return (
    <div className={"flex gap-6 items-center " + appendClassName} {...props}>
      ...
      <Link href={`mailto:?subject=${title}&body=${url}`} target="_blank">
        <div className="flex gap-1 items-center">
          <svg
            width="20"
            height="15"
      ...
      <Link href={`https://wa.me/?text=${title} ${url}`} target="_blank">
        <div className="flex gap-1 items-center">
          <svg
            width="20"
            height="15"
      ...
      {!copied ? (
        ...
        <div className="flex gap-1 items-center cursor-default">
          ...
          <span className="text-[13px] font-helvetica">Link Copied</span>
        </div>
      )}
    </div>
  );
