...
import { MdDelete, MdEvent, MdModeEdit, MdRsvp } from "react-icons/md";
import {
  Modal,
  ModalBody,
  ModalContent,
            ...
            <div className="flex items-center p-4 border divide-x divide-dashed divide-[#1f1d1a19] border-dashed border-[#1f1d1a] rounded-2xl bg-lightPrimary">
              <div className="flex-1">
                ...
                <p>
                  ...
                  <b>{dayjs(event.startTime).format("MMMM DD, YYYY")}</b>
                </p>
                <p>
                  {/* <b>09:00 AM</b> */}
                  <b>{dayjs(event.startTime).format("hh:mm A")}</b>
                </p>
              </div>
              <div className="flex-1 pl-4">
                ...
                <p>
                  {/* <b>September 07, 2024</b> */}
                  <b>{dayjs(event.endTime).format("MMMM DD, YYYY")}</b>
                </p>
                <p>
                  {/* <b>11:00 AM</b> */}
                  <b>{dayjs(event.endTime).format("hh:mm A")}</b>
                </p>
              </div>
            </div>
          </div>
